...
if {[file isfile mv_float.autotvin.dat]} {
	file delete -force mv_float.autotvin.dat
}

if {[file isfile mv_float.autotvout.dat]} {
	file delete -force mv_float.autotvout.dat
}
