; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_butterworth/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axi_butterworth_ir(%"class.hls::stream"* %in_amplitude_data, %"class.hls::stream"* %out_iir_data) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_axi_butterworth_hw(%"class.hls::stream"* %in_amplitude_data_copy1, %"class.hls::stream"* %out_iir_data_copy2)
...
declare void @apatb_axi_butterworth_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @axi_butterworth_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @axi_butterworth_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @axi_butterworth_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
