...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_butterworth.autotvin.dat"
	set constFileTvOut       "axi_butterworth.autotvout.dat"
	set constFileHdlTvIn     "axi_butterworth.autohdltvin.dat"
	set constFileHdlTvOut    "axi_butterworth.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
