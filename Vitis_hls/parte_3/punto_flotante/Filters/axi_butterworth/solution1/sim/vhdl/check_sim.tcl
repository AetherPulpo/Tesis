...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_butterworth.autotvin_in_amplitude_data_V.dat"
         "c.axi_butterworth.autotvin_out_iir_data_V.dat"
         "c.axi_butterworth.autotvout_out_iir_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_butterworth.autotvout_out_iir_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
