...
if {[file isfile axi_butterworth.autotvin.dat]} {
	file delete -force axi_butterworth.autotvin.dat
}

if {[file isfile axi_butterworth.autotvout.dat]} {
	file delete -force axi_butterworth.autotvout.dat
}
