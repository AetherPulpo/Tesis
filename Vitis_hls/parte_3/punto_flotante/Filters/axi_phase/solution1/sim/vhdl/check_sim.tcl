...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_phase.autotvin_in_complex_data_V.dat"
         "c.axi_phase.autotvin_out_phase_V.dat"
         "c.axi_phase.autotvout_out_phase_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_phase.autotvout_out_phase_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
