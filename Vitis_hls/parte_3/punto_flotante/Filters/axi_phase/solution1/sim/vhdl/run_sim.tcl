...
if {[file isfile axi_phase.autotvin.dat]} {
	file delete -force axi_phase.autotvin.dat
}

if {[file isfile axi_phase.autotvout.dat]} {
	file delete -force axi_phase.autotvout.dat
}
