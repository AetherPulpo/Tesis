...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_phase.autotvin.dat"
	set constFileTvOut       "axi_phase.autotvout.dat"
	set constFileHdlTvIn     "axi_phase.autohdltvin.dat"
	set constFileHdlTvOut    "axi_phase.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
