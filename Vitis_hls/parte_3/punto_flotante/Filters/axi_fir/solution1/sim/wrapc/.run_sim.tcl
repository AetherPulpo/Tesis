...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_fir.autotvin.dat"
	set constFileTvOut       "axi_fir.autotvout.dat"
	set constFileHdlTvIn     "axi_fir.autohdltvin.dat"
	set constFileHdlTvOut    "axi_fir.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
