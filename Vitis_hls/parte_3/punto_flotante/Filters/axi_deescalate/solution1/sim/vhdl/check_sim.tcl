...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_deescalate.autotvin_in_modulus_scale_data_V.dat"
         "c.axi_deescalate.autotvin_out_data_V.dat"
         "c.axi_deescalate.autotvout_out_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_deescalate.autotvout_out_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
