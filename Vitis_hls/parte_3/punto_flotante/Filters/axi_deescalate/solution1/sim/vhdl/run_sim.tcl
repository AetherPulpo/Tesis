...
if {[file isfile axi_deescalate.autotvin.dat]} {
	file delete -force axi_deescalate.autotvin.dat
}

if {[file isfile axi_deescalate.autotvout.dat]} {
	file delete -force axi_deescalate.autotvout.dat
}
