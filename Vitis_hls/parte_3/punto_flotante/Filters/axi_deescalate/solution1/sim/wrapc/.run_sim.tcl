...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_deescalate.autotvin.dat"
	set constFileTvOut       "axi_deescalate.autotvout.dat"
	set constFileHdlTvIn     "axi_deescalate.autohdltvin.dat"
	set constFileHdlTvOut    "axi_deescalate.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
