...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_cut_zeroes.autotvin.dat"
	set constFileTvOut       "axi_cut_zeroes.autotvout.dat"
	set constFileHdlTvIn     "axi_cut_zeroes.autohdltvin.dat"
	set constFileHdlTvOut    "axi_cut_zeroes.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
