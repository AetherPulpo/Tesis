...
if {[file isfile axi_cut_zeroes.autotvin.dat]} {
	file delete -force axi_cut_zeroes.autotvin.dat
}

if {[file isfile axi_cut_zeroes.autotvout.dat]} {
	file delete -force axi_cut_zeroes.autotvout.dat
}
