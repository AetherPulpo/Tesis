...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_cut_zeroes.autotvin_in_data_V.dat"
         "c.axi_cut_zeroes.autotvin_out_cut_data_V.dat"
         "c.axi_cut_zeroes.autotvout_out_cut_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_cut_zeroes.autotvout_out_cut_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
