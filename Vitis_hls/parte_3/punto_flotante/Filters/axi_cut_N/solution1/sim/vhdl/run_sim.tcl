...
if {[file isfile axi_cut_N.autotvin.dat]} {
	file delete -force axi_cut_N.autotvin.dat
}

if {[file isfile axi_cut_N.autotvout.dat]} {
	file delete -force axi_cut_N.autotvout.dat
}
