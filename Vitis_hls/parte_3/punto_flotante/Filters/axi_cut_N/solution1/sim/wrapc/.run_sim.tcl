...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_cut_N.autotvin.dat"
	set constFileTvOut       "axi_cut_N.autotvout.dat"
	set constFileHdlTvIn     "axi_cut_N.autohdltvin.dat"
	set constFileHdlTvOut    "axi_cut_N.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
