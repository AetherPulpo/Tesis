; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_cut_N/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axi_cut_N_ir(%"class.hls::stream"* %in_data, %"class.hls::stream"* %out_cut_data) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_axi_cut_N_hw(%"class.hls::stream"* %in_data_copy1, %"class.hls::stream"* %out_cut_data_copy2)
...
declare void @apatb_axi_cut_N_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @axi_cut_N_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @axi_cut_N_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @axi_cut_N_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
