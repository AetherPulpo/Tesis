; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_polar_translate/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axi_polar_translate_ir(%"class.hls::stream"* %in_data, %"class.hls::stream.1"* %out_modulus, %"class.hls::stream.1"* %out_phase) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_axi_polar_translate_hw(%"class.hls::stream"* %in_data_copy, %"class.hls::stream.1"* %out_modulus_copy1, %"class.hls::stream.1"* %out_phase_copy2)
...
declare void @apatb_axi_polar_translate_hw(%"class.hls::stream"*, %"class.hls::stream.1"*, %"class.hls::stream.1"*)

define void @axi_polar_translate_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.1"*, %"class.hls::stream.1"*) #6 {
entry:
  ...
  call void @axi_polar_translate_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.1"* %1, %"class.hls::stream.1"* %2)
...
declare void @axi_polar_translate_hw_stub(%"class.hls::stream"*, %"class.hls::stream.1"*, %"class.hls::stream.1"*)
