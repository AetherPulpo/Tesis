...
module axi_polar_translate_atan2_cordic_float_s (
        ap_clk,
        ap_rst,
        y_in,
        x_in,
...
axi_polar_translate_atan2_generic_float_s grp_atan2_generic_float_s_fu_169(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
axi_polar_translate_fsub_32ns_32ns_32_5_full_dsp_0 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
axi_polar_translate_fcmp_32ns_32ns_1_2_no_dsp_0 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
endmodule //axi_polar_translate_atan2_cordic_float_s
