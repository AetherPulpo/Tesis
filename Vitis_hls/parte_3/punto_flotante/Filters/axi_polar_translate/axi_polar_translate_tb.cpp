...
//    ComplexType X_m = {1,1};  //FFT de una senal de entrada
	...
	fpw1 = fopen("../../../../../axipolar_translate_modulus.dat","w");
	fpw2 = fopen("../../../../../axipolar_translate_phase.dat","w");
    ...
    axi_polar_translate (test_input, test_output_modulus, test_output_phase);
    ...
    for (int i = 0; i < NEW_DATA_SIZE; i++){
        ...
        std::cout << "Entrada Compleja[" << i <<"]: "<< input_read[i]  << " Modulo [" << i <<"]: " << test_result_modulus[i] << " Fase [" << i <<"]: " << test_result_phase[i] <<  std::endl;
