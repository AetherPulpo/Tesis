...
set hlsProjectName butter_double
...
set simtbs [glob -nocomplain ./sim_tbs/*.v ./sim_tbs/*.vhd ./sim_tbs/*.sv ./sim_tbs/cdatafile/*.dat ./sim_tbs/rtldatafile/*.dat ./sim_tbs/stream_size/*.dat]
if {$simtbs != "" } {
...
set ip_vlnv xilinx.com:hls:butterworth_double:1.0
set ip_repo_path {../ip}
set assign_slr ""
