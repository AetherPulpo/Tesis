...
proc create_root_design { parentCell } {
  ...
  set in_amplitude_data_V [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 in_amplitude_data_V ]
  ...
  set out_iir_data_V [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 out_iir_data_V ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000.0} \
   ] $out_iir_data_V
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:butterworth_double:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net ap_ctrl_0_1 [get_bd_intf_ports ap_ctrl] [get_bd_intf_pins hls_inst/ap_ctrl]
  connect_bd_intf_net -intf_net hls_inst_out_iir_data_V [get_bd_intf_ports out_iir_data_V] [get_bd_intf_pins hls_inst/out_iir_data_V]
  connect_bd_intf_net -intf_net in_amplitude_data_V_0_1 [get_bd_intf_ports in_amplitude_data_V] [get_bd_intf_pins hls_inst/in_amplitude_data_V]
