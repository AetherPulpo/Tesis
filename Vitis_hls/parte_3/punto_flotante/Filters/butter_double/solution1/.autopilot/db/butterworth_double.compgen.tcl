...
set id 1
set name butterworth_double_fptrunc_64ns_32_2_no_dsp_1
...
set id 2
set name butterworth_double_fpext_32ns_64_2_no_dsp_1
...
set id 3
set name butterworth_double_dadddsub_64ns_64ns_64_7_full_dsp_1
...
set id 5
set name butterworth_double_dmul_64ns_64ns_64_7_max_dsp_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 10 \
    name in_amplitude_data_V \
    reset_level 0 \
    sync_rst true \
    corename {} \
    metadata {  } \
    op interface \
    ports { in_amplitude_data_V_TDATA { I 32 vector } in_amplitude_data_V_TVALID { I 1 bit } in_amplitude_data_V_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'in_amplitude_data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_iir_data_V_TDATA { O 32 vector } out_iir_data_V_TVALID { O 1 bit } out_iir_data_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'out_iir_data_V'"
}
}
...
# RegSlice definition:
set ID 12
set RegSliceName butterworth_double_regslice_both
set RegSliceInstName butterworth_double_regslice_both_U
set CoreName ap_simcore_butterworth_double_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
