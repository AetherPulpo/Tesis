...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "butterworth_double.autotvin.dat"
	set constFileTvOut       "butterworth_double.autotvout.dat"
	set constFileHdlTvIn     "butterworth_double.autohdltvin.dat"
	set constFileHdlTvOut    "butterworth_double.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
