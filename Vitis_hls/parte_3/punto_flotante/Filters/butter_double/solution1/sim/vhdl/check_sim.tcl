...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.butterworth_double.autotvin_in_amplitude_data_V.dat"
         "c.butterworth_double.autotvin_out_iir_data_V.dat"
         "c.butterworth_double.autotvout_out_iir_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.butterworth_double.autotvout_out_iir_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
