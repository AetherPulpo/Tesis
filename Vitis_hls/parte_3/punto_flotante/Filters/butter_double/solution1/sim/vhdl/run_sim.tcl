...
if {[file isfile butterworth_double.autotvin.dat]} {
	file delete -force butterworth_double.autotvin.dat
}

if {[file isfile butterworth_double.autotvout.dat]} {
	file delete -force butterworth_double.autotvout.dat
}
