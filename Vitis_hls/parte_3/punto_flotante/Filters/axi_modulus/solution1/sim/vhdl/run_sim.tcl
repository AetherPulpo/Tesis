...
if {[file isfile axi_modulus.autotvin.dat]} {
	file delete -force axi_modulus.autotvin.dat
}

if {[file isfile axi_modulus.autotvout.dat]} {
	file delete -force axi_modulus.autotvout.dat
}
