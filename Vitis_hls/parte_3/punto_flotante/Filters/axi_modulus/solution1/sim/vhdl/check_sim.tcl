...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_modulus.autotvin_in_complex_data_V.dat"
         "c.axi_modulus.autotvin_out_modulus_V.dat"
         "c.axi_modulus.autotvout_out_modulus_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_modulus.autotvout_out_modulus_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
