...
$(ObjDir)/axi_modulus_tb.cpp_pre.cpp.tb.o : axi_modulus_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling axi_modulus_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/axi_modulus.cpp_pre.cpp.tb.o : axi_modulus.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling axi_modulus.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
