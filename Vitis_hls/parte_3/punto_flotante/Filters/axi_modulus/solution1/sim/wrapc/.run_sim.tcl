...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_modulus.autotvin.dat"
	set constFileTvOut       "axi_modulus.autotvout.dat"
	set constFileHdlTvIn     "axi_modulus.autohdltvin.dat"
	set constFileHdlTvOut    "axi_modulus.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
