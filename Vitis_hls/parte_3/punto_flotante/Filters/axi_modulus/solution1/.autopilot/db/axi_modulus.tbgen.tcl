...
set RtlHierarchyInfo {[
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_in_complex_data_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_modulus_V_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	axi_modulus {
		in_complex_data_V {Type I LastRead 1 FirstWrite -1}
		out_modulus_V {Type O LastRead -1 FirstWrite 26}}}
