...
set Library     "hls"
set IPName      "axi_bottle"
set Version     "1.0"
set DisplayName "Axi_bottle"
set Revision    "2113597975"
...
set xo_kernel_name "axi_bottle"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_bottle/solution1"
set debug_dir "/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_bottle/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {axi_bottle_regslice_both
...
set Interfaces {
    ap_clk {
        ...
        buses "in_complex_data_V out_complex_data_1_V out_complex_data_2_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    out_complex_data_1_V {
        type "axi4stream"
        mode "master"
        port_prefix "out_complex_data_1_V"
        has_tready "1"
        ports {
            TDATA 64
        }
    ...
    out_complex_data_2_V {
        type "axi4stream"
        mode "master"
        port_prefix "out_complex_data_2_V"
        has_tready "1"
        ports {
            TDATA 64
        }
