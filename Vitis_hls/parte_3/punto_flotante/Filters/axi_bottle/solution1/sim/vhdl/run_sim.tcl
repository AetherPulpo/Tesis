...
if {[file isfile axi_bottle.autotvin.dat]} {
	file delete -force axi_bottle.autotvin.dat
}

if {[file isfile axi_bottle.autotvout.dat]} {
	file delete -force axi_bottle.autotvout.dat
}
