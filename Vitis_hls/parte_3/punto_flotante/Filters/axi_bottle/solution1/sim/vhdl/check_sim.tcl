...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_bottle.autotvin_in_complex_data_V.dat"
         "c.axi_bottle.autotvin_out_complex_data_1_V.dat"
         "c.axi_bottle.autotvin_out_complex_data_2_V.dat"
         "c.axi_bottle.autotvout_out_complex_data_1_V.dat"
         "c.axi_bottle.autotvout_out_complex_data_2_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_bottle.autotvout_out_complex_data_1_V.dat"
         "rtl.axi_bottle.autotvout_out_complex_data_2_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
