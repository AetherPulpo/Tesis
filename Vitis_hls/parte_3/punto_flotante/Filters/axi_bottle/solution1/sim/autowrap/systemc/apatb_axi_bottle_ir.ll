; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_bottle/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axi_bottle_ir(%"class.hls::stream"* %in_complex_data, %"class.hls::stream"* %out_complex_data_1, %"class.hls::stream"* %out_complex_data_2) local_unnamed_addr #0 {
entry:
  %in_complex_data_copy = alloca %"class.hls::stream", align 512
  %out_complex_data_1_copy = alloca %"class.hls::stream", align 512
  %out_complex_data_2_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_complex_data, %"class.hls::stream"* nonnull align 512 %in_complex_data_copy, %"class.hls::stream"* %out_complex_data_1, %"class.hls::stream"* nonnull align 512 %out_complex_data_1_copy, %"class.hls::stream"* %out_complex_data_2, %"class.hls::stream"* nonnull align 512 %out_complex_data_2_copy)
  call void @apatb_axi_bottle_hw(%"class.hls::stream"* %in_complex_data_copy, %"class.hls::stream"* %out_complex_data_1_copy, %"class.hls::stream"* %out_complex_data_2_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %in_complex_data, %"class.hls::stream"* nonnull align 512 %in_complex_data_copy, %"class.hls::stream"* %out_complex_data_1, %"class.hls::stream"* nonnull align 512 %out_complex_data_1_copy, %"class.hls::stream"* %out_complex_data_2, %"class.hls::stream"* nonnull align 512 %out_complex_data_2_copy)
  ret void
}
...
declare void @apatb_axi_bottle_hw(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)

define void @axi_bottle_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  ...
  call void @axi_bottle_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %"class.hls::stream"* %2)
...
declare void @axi_bottle_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)
