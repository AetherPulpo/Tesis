...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_bottle.autotvin.dat"
	set constFileTvOut       "axi_bottle.autotvout.dat"
	set constFileHdlTvIn     "axi_bottle.autohdltvin.dat"
	set constFileHdlTvOut    "axi_bottle.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
