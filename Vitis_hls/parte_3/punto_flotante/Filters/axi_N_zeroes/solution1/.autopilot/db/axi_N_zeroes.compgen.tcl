...
# RegSlice definition:
set ID 3
set RegSliceName axi_N_zeroes_regslice_both
set RegSliceInstName axi_N_zeroes_regslice_both_U
set CoreName ap_simcore_axi_N_zeroes_regslice_both
