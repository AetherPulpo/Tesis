; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_N_zeroes/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axi_N_zeroes_ir(%"class.hls::stream"* %in_data, %"class.hls::stream"* %out_data) local_unnamed_addr #0 {
entry:
  %in_data_copy1 = alloca %"class.hls::stream", align 512
  %out_data_copy2 = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy1, %"class.hls::stream"* %out_data, %"class.hls::stream"* nonnull align 512 %out_data_copy2)
  call void @apatb_axi_N_zeroes_hw(%"class.hls::stream"* %in_data_copy1, %"class.hls::stream"* %out_data_copy2)
  call fastcc void @copy_out(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy1, %"class.hls::stream"* %out_data, %"class.hls::stream"* nonnull align 512 %out_data_copy2)
  ret void
}
...
declare void @apatb_axi_N_zeroes_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @axi_N_zeroes_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @axi_N_zeroes_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @axi_N_zeroes_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
