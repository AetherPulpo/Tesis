...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_N_zeroes.autotvin.dat"
	set constFileTvOut       "axi_N_zeroes.autotvout.dat"
	set constFileHdlTvIn     "axi_N_zeroes.autohdltvin.dat"
	set constFileHdlTvOut    "axi_N_zeroes.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
