...
if {[file isfile axi_N_zeroes.autotvin.dat]} {
	file delete -force axi_N_zeroes.autotvin.dat
}

if {[file isfile axi_N_zeroes.autotvout.dat]} {
	file delete -force axi_N_zeroes.autotvout.dat
}
