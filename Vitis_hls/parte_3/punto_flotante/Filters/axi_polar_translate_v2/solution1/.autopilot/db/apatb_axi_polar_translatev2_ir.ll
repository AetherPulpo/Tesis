; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_polar_translate_v2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%"class.hls::stream.1" = type { %"class.hls::stream.2" }
%"class.hls::stream.2" = type { float }

; Function Attrs: noinline
define void @apatb_axi_polar_translatev2_ir(%"class.hls::stream"* %in_data, %"class.hls::stream.1"* %out_modulus, %"class.hls::stream.1"* %out_phase) local_unnamed_addr #0 {
entry:
  %in_data_copy = alloca %"class.hls::stream", align 512
  %out_modulus_copy1 = alloca %"class.hls::stream.1", align 512
  %out_phase_copy2 = alloca %"class.hls::stream.1", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy, %"class.hls::stream.1"* %out_modulus, %"class.hls::stream.1"* nonnull align 512 %out_modulus_copy1, %"class.hls::stream.1"* %out_phase, %"class.hls::stream.1"* nonnull align 512 %out_phase_copy2)
  call void @apatb_axi_polar_translatev2_hw(%"class.hls::stream"* %in_data_copy, %"class.hls::stream.1"* %out_modulus_copy1, %"class.hls::stream.1"* %out_phase_copy2)
  call fastcc void @copy_out(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy, %"class.hls::stream.1"* %out_modulus, %"class.hls::stream.1"* nonnull align 512 %out_modulus_copy1, %"class.hls::stream.1"* %out_phase, %"class.hls::stream.1"* nonnull align 512 %out_phase_copy2)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.1"*, %"class.hls::stream.1"* noalias align 512, %"class.hls::stream.1"*, %"class.hls::stream.1"* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* align 512 %1, %"class.hls::stream"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.1"(%"class.hls::stream.1"* align 512 %3, %"class.hls::stream.1"* %2)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.1"(%"class.hls::stream.1"* align 512 %5, %"class.hls::stream.1"* %4)
  ret void
}
...
; <label>:8:                                      ; preds = %copy
  %.0 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %1, i32 0, i32 0
  %.01 = getelementptr %"class.hls::stream.1", %"class.hls::stream.1"* %0, i32 0, i32 0
  %9 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %9, label %10, label %11

; <label>:10:                                     ; preds = %8
  call fastcc void @"streamcpy_hls.p0class.hls::stream.2"(%"class.hls::stream.2"* align 512 %.01, %"class.hls::stream.2"* %.0)
  br label %ret

; <label>:11:                                     ; preds = %8
  %12 = bitcast %"class.hls::stream.1"* %0 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %12, i8* align 1 %5, i64 4, i1 false)
  br label %ret

ret:                                              ; preds = %11, %10, %7, %entry
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.2"(%"class.hls::stream.2"* noalias nocapture align 512, %"class.hls::stream.2"* noalias nocapture) unnamed_addr #3 {
entry:
  %2 = alloca %"class.hls::stream.2"
  br label %empty

empty:                                            ; preds = %push, %entry
  %3 = bitcast %"class.hls::stream.2"* %1 to i8*
  %4 = call i1 @fpga_fifo_not_empty_4(i8* %3)
  br i1 %4, label %push, label %ret

push:                                             ; preds = %empty
  %5 = bitcast %"class.hls::stream.2"* %2 to i8*
  %6 = bitcast %"class.hls::stream.2"* %1 to i8*
  call void @fpga_fifo_pop_4(i8* %5, i8* %6)
  %7 = load volatile %"class.hls::stream.2", %"class.hls::stream.2"* %2
  %8 = bitcast %"class.hls::stream.2"* %2 to i8*
  %9 = bitcast %"class.hls::stream.2"* %0 to i8*
  call void @fpga_fifo_push_4(i8* %8, i8* %9)
  br label %empty, !llvm.loop !10

ret:                                              ; preds = %empty
  %10 = bitcast %"class.hls::stream.2"* %1 to i8*
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.1"*, %"class.hls::stream.1"* noalias align 512, %"class.hls::stream.1"*, %"class.hls::stream.1"* noalias align 512) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* %0, %"class.hls::stream"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.1"(%"class.hls::stream.1"* %2, %"class.hls::stream.1"* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.1"(%"class.hls::stream.1"* %4, %"class.hls::stream.1"* align 512 %5)
  ret void
}

declare void @apatb_axi_polar_translatev2_hw(%"class.hls::stream"*, %"class.hls::stream.1"*, %"class.hls::stream.1"*)

define void @axi_polar_translatev2_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.1"*, %"class.hls::stream.1"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.1"* null, %"class.hls::stream.1"* %1, %"class.hls::stream.1"* null, %"class.hls::stream.1"* %2)
  call void @axi_polar_translatev2_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.1"* %1, %"class.hls::stream.1"* %2)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.1"* null, %"class.hls::stream.1"* %1, %"class.hls::stream.1"* null, %"class.hls::stream.1"* %2)
  ret void
}

declare void @axi_polar_translatev2_hw_stub(%"class.hls::stream"*, %"class.hls::stream.1"*, %"class.hls::stream.1"*)
