...
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vitis_HLS/2020.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_polar_translatev2.autotvin.dat"
	set constFileTvOut       "axi_polar_translatev2.autotvout.dat"
	set constFileHdlTvIn     "axi_polar_translatev2.autohdltvin.dat"
	set constFileHdlTvOut    "axi_polar_translatev2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
