...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_polar_translatev2.autotvin_in_data_V.dat"
         "c.axi_polar_translatev2.autotvin_out_modulus_V.dat"
         "c.axi_polar_translatev2.autotvin_out_phase_V.dat"
         "c.axi_polar_translatev2.autotvout_out_modulus_V.dat"
         "c.axi_polar_translatev2.autotvout_out_phase_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_polar_translatev2.autotvout_out_modulus_V.dat"
         "rtl.axi_polar_translatev2.autotvout_out_phase_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
