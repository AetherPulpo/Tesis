...
if {[file isfile axi_polar_translatev2.autotvin.dat]} {
	file delete -force axi_polar_translatev2.autotvin.dat
}

if {[file isfile axi_polar_translatev2.autotvout.dat]} {
	file delete -force axi_polar_translatev2.autotvout.dat
}
