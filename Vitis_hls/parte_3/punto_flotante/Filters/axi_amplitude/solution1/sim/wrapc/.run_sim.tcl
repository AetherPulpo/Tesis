...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_amplitude.autotvin.dat"
	set constFileTvOut       "axi_amplitude.autotvout.dat"
	set constFileHdlTvIn     "axi_amplitude.autohdltvin.dat"
	set constFileHdlTvOut    "axi_amplitude.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
