...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_amplitude.autotvin_in_phase_data_V.dat"
         "c.axi_amplitude.autotvin_in_modulus_data_V.dat"
         "c.axi_amplitude.autotvin_out_amplitude_data_V.dat"
         "c.axi_amplitude.autotvout_out_amplitude_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_amplitude.autotvout_out_amplitude_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
