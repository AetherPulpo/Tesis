...
if {[file isfile axi_amplitude.autotvin.dat]} {
	file delete -force axi_amplitude.autotvin.dat
}

if {[file isfile axi_amplitude.autotvout.dat]} {
	file delete -force axi_amplitude.autotvout.dat
}
