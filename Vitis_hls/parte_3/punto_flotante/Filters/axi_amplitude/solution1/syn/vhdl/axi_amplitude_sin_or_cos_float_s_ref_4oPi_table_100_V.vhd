...
entity axi_amplitude_sin_or_cos_float_s_ref_4oPi_table_100_V_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of axi_amplitude_sin_or_cos_float_s_ref_4oPi_table_100_V_rom is 
...
entity axi_amplitude_sin_or_cos_float_s_ref_4oPi_table_100_V is
    generic (
...
architecture arch of axi_amplitude_sin_or_cos_float_s_ref_4oPi_table_100_V is
    component axi_amplitude_sin_or_cos_float_s_ref_4oPi_table_100_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    axi_amplitude_sin_or_cos_float_s_ref_4oPi_table_100_V_rom_U :  component axi_amplitude_sin_or_cos_float_s_ref_4oPi_table_100_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
