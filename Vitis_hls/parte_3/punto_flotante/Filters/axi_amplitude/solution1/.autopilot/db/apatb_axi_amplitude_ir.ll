; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/Filters/axi_amplitude/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axi_amplitude_ir(%"class.hls::stream"* %in_phase_data, %"class.hls::stream"* %in_modulus_data, %"class.hls::stream"* %out_amplitude_data) local_unnamed_addr #0 {
entry:
  %in_phase_data_copy1 = alloca %"class.hls::stream", align 512
  %in_modulus_data_copy2 = alloca %"class.hls::stream", align 512
  %out_amplitude_data_copy3 = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_phase_data, %"class.hls::stream"* nonnull align 512 %in_phase_data_copy1, %"class.hls::stream"* %in_modulus_data, %"class.hls::stream"* nonnull align 512 %in_modulus_data_copy2, %"class.hls::stream"* %out_amplitude_data, %"class.hls::stream"* nonnull align 512 %out_amplitude_data_copy3)
  call void @apatb_axi_amplitude_hw(%"class.hls::stream"* %in_phase_data_copy1, %"class.hls::stream"* %in_modulus_data_copy2, %"class.hls::stream"* %out_amplitude_data_copy3)
  call fastcc void @copy_out(%"class.hls::stream"* %in_phase_data, %"class.hls::stream"* nonnull align 512 %in_phase_data_copy1, %"class.hls::stream"* %in_modulus_data, %"class.hls::stream"* nonnull align 512 %in_modulus_data_copy2, %"class.hls::stream"* %out_amplitude_data, %"class.hls::stream"* nonnull align 512 %out_amplitude_data_copy3)
  ret void
}
...
declare void @apatb_axi_amplitude_hw(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)

define void @axi_amplitude_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  ...
  call void @axi_amplitude_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %"class.hls::stream"* %2)
...
declare void @axi_amplitude_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)
