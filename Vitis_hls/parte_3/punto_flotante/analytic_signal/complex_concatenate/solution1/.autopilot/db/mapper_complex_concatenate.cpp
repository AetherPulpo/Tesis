...
extern "C" void complex_concatenate(float*, __cosim_s8__*);
extern "C" void apatb_complex_concatenate_hw(volatile void * __xlx_apatb_param_in_data, volatile void * __xlx_apatb_param_out_data) {
  ...
  vector<float> __xlx_in_data_tmp_vec;
  while (!((hls::stream<float>*)__xlx_apatb_param_in_data)->empty() && __xlx_in_data_V_tmp_Count < __xlx_in_data_V_read_Size) {
    __xlx_in_data_tmp_vec.push_back(((hls::stream<float>*)__xlx_apatb_param_in_data)->read());
    __xlx_in_data_V_tmp_Count++;
  }
  ap_apatb_in_data_V_cap_bc = __xlx_in_data_tmp_vec.size();
  // store input buffer
  float* __xlx_in_data_input_buffer= new float[__xlx_in_data_tmp_vec.size()];
  ...
  // DUT call
  complex_concatenate(__xlx_in_data_input_buffer, __xlx_out_data_input_buffer);
