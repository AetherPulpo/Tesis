...
# RegSlice definition:
set ID 3
set RegSliceName complex_concatenate_regslice_both
set RegSliceInstName complex_concatenate_regslice_both_U
set CoreName ap_simcore_complex_concatenate_regslice_both
