...
// wrapc file define:
#define AUTOTB_TVIN_in_data_V "../tv/cdatafile/c.complex_concatenate.autotvin_in_data_V.dat"
#define AUTOTB_TVOUT_in_data_V "../tv/cdatafile/c.complex_concatenate.autotvout_in_data_V.dat"
...
// wrapc file define:
#define AUTOTB_TVIN_out_data_V "../tv/cdatafile/c.complex_concatenate.autotvin_out_data_V.dat"
#define AUTOTB_TVOUT_out_data_V "../tv/cdatafile/c.complex_concatenate.autotvout_out_data_V.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_in_data_V "../tv/rtldatafile/rtl.complex_concatenate.autotvout_in_data_V.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_out_data_V "../tv/rtldatafile/rtl.complex_concatenate.autotvout_out_data_V.dat"
...
extern "C" void complex_concatenate_hw_stub_wrapper(volatile void *, volatile void *);

extern "C" void apatb_complex_concatenate_hw(volatile void * __xlx_apatb_param_in_data, volatile void * __xlx_apatb_param_out_data) {
    ...
    string AESL_num;long __xlx_apatb_param_in_data_V_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_in_data_V_stream_buf_final_size; ++i)((hls::stream<float>*)__xlx_apatb_param_in_data)->read();
...
std::vector<float> __xlx_apatb_param_in_data_stream_buf;
{
  while (!((hls::stream<float>*)__xlx_apatb_param_in_data)->empty())
    __xlx_apatb_param_in_data_stream_buf.push_back(((hls::stream<float>*)__xlx_apatb_param_in_data)->read());
  for (int i = 0; i < __xlx_apatb_param_in_data_stream_buf.size(); ++i)
    ((hls::stream<float>*)__xlx_apatb_param_in_data)->write(__xlx_apatb_param_in_data_stream_buf[i]);
  }
long __xlx_apatb_param_in_data_stream_buf_size = ((hls::stream<float>*)__xlx_apatb_param_in_data)->size();
...
complex_concatenate_hw_stub_wrapper(__xlx_apatb_param_in_data, __xlx_apatb_param_out_data);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_in_data_stream_buf_final_size = __xlx_apatb_param_in_data_stream_buf_size - ((hls::stream<float>*)__xlx_apatb_param_in_data)->size();
