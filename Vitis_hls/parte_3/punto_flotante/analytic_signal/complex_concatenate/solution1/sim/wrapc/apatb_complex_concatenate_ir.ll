; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/analytic_signal/complex_concatenate/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_complex_concatenate_ir(%"class.hls::stream"* %in_data, %"class.hls::stream.0"* %out_data) local_unnamed_addr #0 {
entry:
  %in_data_copy1 = alloca %"class.hls::stream", align 512
  %out_data_copy = alloca %"class.hls::stream.0", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy1, %"class.hls::stream.0"* %out_data, %"class.hls::stream.0"* nonnull align 512 %out_data_copy)
  call void @apatb_complex_concatenate_hw(%"class.hls::stream"* %in_data_copy1, %"class.hls::stream.0"* %out_data_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy1, %"class.hls::stream.0"* %out_data, %"class.hls::stream.0"* nonnull align 512 %out_data_copy)
  ret void
}
...
; <label>:8:                                      ; preds = %copy
  %.0 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0
  %.01 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0
  %9 = call i1 @fpga_fifo_exist_8(i8* %5)
  br i1 %9, label %10, label %11

; <label>:10:                                     ; preds = %8
  call fastcc void @"streamcpy_hls.p0struct.std::complex"(%"struct.std::complex"* align 512 %.01, %"struct.std::complex"* %.0)
  br label %ret

; <label>:11:                                     ; preds = %8
  %12 = bitcast %"class.hls::stream.0"* %0 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %12, i8* align 1 %5, i64 4, i1 false)
  %.01.0.17.gep9 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 0, i32 1
  %13 = bitcast float* %.01.0.17.gep9 to i8*
  %.0.0.16.gep10 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 1
  %14 = bitcast float* %.0.0.16.gep10 to i8*
...
declare void @apatb_complex_concatenate_hw(%"class.hls::stream"*, %"class.hls::stream.0"*)

define void @complex_concatenate_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.0"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  call void @complex_concatenate_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.0"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  ret void
}

declare void @complex_concatenate_hw_stub(%"class.hls::stream"*, %"class.hls::stream.0"*)
