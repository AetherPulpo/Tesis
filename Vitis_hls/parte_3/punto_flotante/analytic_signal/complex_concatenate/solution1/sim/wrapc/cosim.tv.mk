...
$(ObjDir)/complex_concatenate_tb.cpp_pre.cpp.tb.o : complex_concatenate_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling complex_concatenate_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/complex_concatenate.cpp_pre.cpp.tb.o : complex_concatenate.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling complex_concatenate.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
