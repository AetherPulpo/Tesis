...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "complex_concatenate.autotvin.dat"
	set constFileTvOut       "complex_concatenate.autotvout.dat"
	set constFileHdlTvIn     "complex_concatenate.autohdltvin.dat"
	set constFileHdlTvOut    "complex_concatenate.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
