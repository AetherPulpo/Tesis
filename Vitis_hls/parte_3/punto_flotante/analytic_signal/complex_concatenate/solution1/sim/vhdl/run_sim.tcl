...
if {[file isfile complex_concatenate.autotvin.dat]} {
	file delete -force complex_concatenate.autotvin.dat
}

if {[file isfile complex_concatenate.autotvout.dat]} {
	file delete -force complex_concatenate.autotvout.dat
}
