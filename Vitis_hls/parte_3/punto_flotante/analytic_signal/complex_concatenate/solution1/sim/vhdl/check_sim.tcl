...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.complex_concatenate.autotvin_in_data_V.dat"
         "c.complex_concatenate.autotvin_out_data_V.dat"
         "c.complex_concatenate.autotvout_out_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.complex_concatenate.autotvout_out_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
