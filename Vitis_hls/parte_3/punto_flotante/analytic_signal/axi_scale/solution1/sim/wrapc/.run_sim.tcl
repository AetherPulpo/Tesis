...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_scale.autotvin.dat"
	set constFileTvOut       "axi_scale.autotvout.dat"
	set constFileHdlTvIn     "axi_scale.autohdltvin.dat"
	set constFileHdlTvOut    "axi_scale.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
