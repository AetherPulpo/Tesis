...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_scale.autotvin_in_ifft_data_V.dat"
         "c.axi_scale.autotvin_out_scale_data_V.dat"
         "c.axi_scale.autotvout_out_scale_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_scale.autotvout_out_scale_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
