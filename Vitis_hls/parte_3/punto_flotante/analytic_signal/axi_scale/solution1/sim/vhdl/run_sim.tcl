...
if {[file isfile axi_scale.autotvin.dat]} {
	file delete -force axi_scale.autotvin.dat
}

if {[file isfile axi_scale.autotvout.dat]} {
	file delete -force axi_scale.autotvout.dat
}
