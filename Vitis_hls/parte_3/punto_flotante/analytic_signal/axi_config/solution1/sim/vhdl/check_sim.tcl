...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axi_config.autotvin_in_config.dat"
         "c.axi_config.autotvin_out_stream_V_data_V.dat"
         "c.axi_config.autotvin_out_stream_V_keep_V.dat"
         "c.axi_config.autotvin_out_stream_V_strb_V.dat"
         "c.axi_config.autotvin_out_stream_V_last_V.dat"
         "c.axi_config.autotvout_out_stream_V_data_V.dat"
         "c.axi_config.autotvout_out_stream_V_keep_V.dat"
         "c.axi_config.autotvout_out_stream_V_strb_V.dat"
         "c.axi_config.autotvout_out_stream_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_config.autotvout_out_stream_V_data_V.dat"
         "rtl.axi_config.autotvout_out_stream_V_keep_V.dat"
         "rtl.axi_config.autotvout_out_stream_V_strb_V.dat"
         "rtl.axi_config.autotvout_out_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
