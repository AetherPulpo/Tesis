...
if {[file isfile axi_config.autotvin.dat]} {
	file delete -force axi_config.autotvin.dat
}

if {[file isfile axi_config.autotvout.dat]} {
	file delete -force axi_config.autotvout.dat
}
