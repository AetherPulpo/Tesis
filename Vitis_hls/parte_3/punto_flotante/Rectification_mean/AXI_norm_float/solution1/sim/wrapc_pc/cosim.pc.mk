...
$(ObjDir)/AXI_norm_float_tb.cpp_pre.cpp.tb.o : AXI_norm_float_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling AXI_norm_float_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/AXI_norm_float.cpp_pre.cpp.tb.o : AXI_norm_float.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling AXI_norm_float.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
