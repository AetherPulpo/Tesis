...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_analytic_fft.autotvin.dat"
	set constFileTvOut       "axi_analytic_fft.autotvout.dat"
	set constFileHdlTvIn     "axi_analytic_fft.autohdltvin.dat"
	set constFileHdlTvOut    "axi_analytic_fft.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
