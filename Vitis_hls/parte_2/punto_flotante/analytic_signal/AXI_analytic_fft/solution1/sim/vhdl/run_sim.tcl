...
if {[file isfile axi_analytic_fft.autotvin.dat]} {
	file delete -force axi_analytic_fft.autotvin.dat
}

if {[file isfile axi_analytic_fft.autotvout.dat]} {
	file delete -force axi_analytic_fft.autotvout.dat
}
