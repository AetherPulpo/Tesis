...
# RegSlice definition:
set ID 3
set RegSliceName AXI_Real2Complex_regslice_both
set RegSliceInstName AXI_Real2Complex_regslice_both_U
set CoreName ap_simcore_AXI_Real2Complex_regslice_both
