...
if {[file isfile AXI_Real2Complex.autotvin.dat]} {
	file delete -force AXI_Real2Complex.autotvin.dat
}

if {[file isfile AXI_Real2Complex.autotvout.dat]} {
	file delete -force AXI_Real2Complex.autotvout.dat
}
