...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AXI_Real2Complex.autotvin_in_data_V.dat"
         "c.AXI_Real2Complex.autotvin_out_data_V.dat"
         "c.AXI_Real2Complex.autotvout_out_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AXI_Real2Complex.autotvout_out_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
