; ModuleID = '/home/usuario/Escritorio/Tesis/IP_V3/punto_flotante/analytic_signal/AXI_Real2Complex/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_AXI_Real2Complex_ir(%"class.hls::stream"* %in_data, %"class.hls::stream.0"* %out_data) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_AXI_Real2Complex_hw(%"class.hls::stream"* %in_data_copy1, %"class.hls::stream.0"* %out_data_copy)
...
declare void @apatb_AXI_Real2Complex_hw(%"class.hls::stream"*, %"class.hls::stream.0"*)

define void @AXI_Real2Complex_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.0"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  call void @AXI_Real2Complex_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.0"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  ret void
}

declare void @AXI_Real2Complex_hw_stub(%"class.hls::stream"*, %"class.hls::stream.0"*)
