...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AXI_Real2Complex.autotvin.dat"
	set constFileTvOut       "AXI_Real2Complex.autotvout.dat"
	set constFileHdlTvIn     "AXI_Real2Complex.autohdltvin.dat"
	set constFileHdlTvOut    "AXI_Real2Complex.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
