...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_config.autotvin.dat"
	set constFileTvOut       "axi_config.autotvout.dat"
	set constFileHdlTvIn     "axi_config.autohdltvin.dat"
	set constFileHdlTvOut    "axi_config.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
