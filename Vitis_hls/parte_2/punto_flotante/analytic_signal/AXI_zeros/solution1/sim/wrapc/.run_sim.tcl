...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AXI_zeros.autotvin.dat"
	set constFileTvOut       "AXI_zeros.autotvout.dat"
	set constFileHdlTvIn     "AXI_zeros.autohdltvin.dat"
	set constFileHdlTvOut    "AXI_zeros.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
