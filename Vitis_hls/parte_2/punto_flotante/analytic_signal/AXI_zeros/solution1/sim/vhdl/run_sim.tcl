...
if {[file isfile AXI_zeros.autotvin.dat]} {
	file delete -force AXI_zeros.autotvin.dat
}

if {[file isfile AXI_zeros.autotvout.dat]} {
	file delete -force AXI_zeros.autotvout.dat
}
