...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AXI_zeros.autotvin_in_zeros.dat"
         "c.AXI_zeros.autotvin_out_stream_V_data_V.dat"
         "c.AXI_zeros.autotvin_out_stream_V_keep_V.dat"
         "c.AXI_zeros.autotvin_out_stream_V_strb_V.dat"
         "c.AXI_zeros.autotvin_out_stream_V_last_V.dat"
         "c.AXI_zeros.autotvout_out_stream_V_data_V.dat"
         "c.AXI_zeros.autotvout_out_stream_V_keep_V.dat"
         "c.AXI_zeros.autotvout_out_stream_V_strb_V.dat"
         "c.AXI_zeros.autotvout_out_stream_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AXI_zeros.autotvout_out_stream_V_data_V.dat"
         "rtl.AXI_zeros.autotvout_out_stream_V_keep_V.dat"
         "rtl.AXI_zeros.autotvout_out_stream_V_strb_V.dat"
         "rtl.AXI_zeros.autotvout_out_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
