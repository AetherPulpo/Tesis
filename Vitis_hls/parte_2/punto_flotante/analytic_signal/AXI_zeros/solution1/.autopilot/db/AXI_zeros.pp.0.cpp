...
# 2 "<built-in>" 2
# 1 "AXI_zeros/AXI_zeros.cpp" 2
# 1 "AXI_zeros/AXI_zeros.h" 1
...
# 2 "AXI_zeros/AXI_zeros.h" 2

# 1 "/opt/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_int.h" 1
# 4 "AXI_zeros/AXI_zeros.h" 2
typedef ap_axiu<64, 0, 0, 0> axi_stream;
const int ZERO_SIZE = 256;


__attribute__((sdx_kernel("AXI_zeros", 0))) void AXI_zeros(ap_uint<64> in_zeros, hls::stream<axi_stream>& out_stream);
# 2 "AXI_zeros/AXI_zeros.cpp" 2


__attribute__((sdx_kernel("AXI_zeros", 0))) void AXI_zeros(ap_uint<64> in_zeros, hls::stream<axi_stream>& out_stream){
#pragma HLS TOP name=AXI_zeros
# 4 "AXI_zeros/AXI_zeros.cpp"
