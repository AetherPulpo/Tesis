...
extern "C" void AXI_zeros(__cosim_s8__, __cosim_s10__*);
extern "C" void apatb_AXI_zeros_hw(__cosim_s8__ __xlx_apatb_param_in_zeros, volatile void * __xlx_apatb_param_out_stream) {
  ...
  __cosim_s10__* __xlx_out_stream_input_buffer= new __cosim_s10__[ap_apatb_out_stream_V_cap_bc];
  // DUT call
  AXI_zeros(__xlx_apatb_param_in_zeros, __xlx_out_stream_input_buffer);
  for (unsigned i = 0; i <ap_apatb_out_stream_V_cap_bc; ++i)
    ((hls::stream<__cosim_s10__>*)__xlx_apatb_param_out_stream)->write(__xlx_out_stream_input_buffer[i]);
}
