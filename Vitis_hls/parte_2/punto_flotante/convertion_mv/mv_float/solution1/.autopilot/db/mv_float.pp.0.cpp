...
# 2 "<built-in>" 2
# 1 "mv_float/mv_float.cpp" 2
# 1 "mv_float/mv_float.h" 1
...
# 5 "mv_float/mv_float.h" 2
const int DATA_SIZE = 512;
const float offset = 0.5;
const float VCC = 3.3;
const float G = 1009.0;
const float two_power_n = 1024.0;
const float milivolts = 1000.0;


__attribute__((sdx_kernel("mv_float", 0))) void mv_float(ap_uint<10> in_data, float* out_data);
# 2 "mv_float/mv_float.cpp" 2
# 12 "mv_float/mv_float.cpp"
__attribute__((sdx_kernel("mv_float", 0))) void mv_float(ap_uint<10> in_data, float* out_data) {
#pragma HLS TOP name=mv_float
# 12 "mv_float/mv_float.cpp"
