...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mv_float.autotvin.dat"
	set constFileTvOut       "mv_float.autotvout.dat"
	set constFileHdlTvIn     "mv_float.autohdltvin.dat"
	set constFileHdlTvOut    "mv_float.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
