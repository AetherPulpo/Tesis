...
if {[file isfile rect_float.autotvin.dat]} {
	file delete -force rect_float.autotvin.dat
}

if {[file isfile rect_float.autotvout.dat]} {
	file delete -force rect_float.autotvout.dat
}
