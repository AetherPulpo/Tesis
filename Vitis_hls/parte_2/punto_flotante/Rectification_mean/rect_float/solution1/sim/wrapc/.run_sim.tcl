...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "rect_float.autotvin.dat"
	set constFileTvOut       "rect_float.autotvout.dat"
	set constFileHdlTvIn     "rect_float.autohdltvin.dat"
	set constFileHdlTvOut    "rect_float.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
