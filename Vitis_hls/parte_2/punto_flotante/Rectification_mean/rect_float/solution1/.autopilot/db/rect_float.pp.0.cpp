...
# 2 "<built-in>" 2
# 1 "rect_float/rect_float.cpp" 2
# 1 "rect_float/rect_float.h" 1



const int DATA_SIZE = 512;
__attribute__((sdx_kernel("rect_float", 0))) void rect_float(float in_data,
    float* out_rec_data);
# 2 "rect_float/rect_float.cpp" 2


__attribute__((sdx_kernel("rect_float", 0))) void rect_float(float in_data,
    float* out_rec_data){
#pragma HLS TOP name=rect_float
# 5 "rect_float/rect_float.cpp"
