...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AXI_norm_float.autotvin.dat"
	set constFileTvOut       "AXI_norm_float.autotvout.dat"
	set constFileHdlTvIn     "AXI_norm_float.autohdltvin.dat"
	set constFileHdlTvOut    "AXI_norm_float.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
