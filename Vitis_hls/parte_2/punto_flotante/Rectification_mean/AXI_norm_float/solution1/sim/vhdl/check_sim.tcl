...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AXI_norm_float.autotvin_in_rect_data.dat"
         "c.AXI_norm_float.autotvin_in_mean.dat"
         "c.AXI_norm_float.autotvin_out_norm_data_V.dat"
         "c.AXI_norm_float.autotvout_out_norm_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AXI_norm_float.autotvout_out_norm_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
