...
if {[file isfile AXI_norm_float.autotvin.dat]} {
	file delete -force AXI_norm_float.autotvin.dat
}

if {[file isfile AXI_norm_float.autotvout.dat]} {
	file delete -force AXI_norm_float.autotvout.dat
}
