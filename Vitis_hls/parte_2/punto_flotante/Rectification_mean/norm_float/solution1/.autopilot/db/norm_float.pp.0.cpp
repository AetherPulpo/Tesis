...
# 2 "<built-in>" 2
# 1 "norm_float/norm_float.cpp" 2
# 1 "norm_float/norm_float.h" 1
const int DATA_SIZE = 512;


__attribute__((sdx_kernel("norm_float", 0))) void norm_float(float in_rect_data,
        float in_mean,
    float* out_norm_data);
# 2 "norm_float/norm_float.cpp" 2


__attribute__((sdx_kernel("norm_float", 0))) void norm_float(float in_rect_data,
        float in_mean,
    float* out_norm_data){
#pragma HLS TOP name=norm_float
# 6 "norm_float/norm_float.cpp"
