...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.norm_float.autotvin_in_rect_data.dat"
         "c.norm_float.autotvin_in_mean.dat"
         "c.norm_float.autotvout_out_norm_data.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.norm_float.autotvout_out_norm_data.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
