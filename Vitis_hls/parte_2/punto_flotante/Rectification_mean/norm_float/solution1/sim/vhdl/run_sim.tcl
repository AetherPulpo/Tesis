...
if {[file isfile norm_float.autotvin.dat]} {
	file delete -force norm_float.autotvin.dat
}

if {[file isfile norm_float.autotvout.dat]} {
	file delete -force norm_float.autotvout.dat
}
