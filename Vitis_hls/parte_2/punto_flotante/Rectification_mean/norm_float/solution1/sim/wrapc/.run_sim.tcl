...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "norm_float.autotvin.dat"
	set constFileTvOut       "norm_float.autotvout.dat"
	set constFileHdlTvIn     "norm_float.autohdltvin.dat"
	set constFileHdlTvOut    "norm_float.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
