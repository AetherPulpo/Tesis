...
if {[file isfile mean_float.autotvin.dat]} {
	file delete -force mean_float.autotvin.dat
}

if {[file isfile mean_float.autotvout.dat]} {
	file delete -force mean_float.autotvout.dat
}
