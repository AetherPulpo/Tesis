...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mean_float.autotvin.dat"
	set constFileTvOut       "mean_float.autotvout.dat"
	set constFileHdlTvIn     "mean_float.autohdltvin.dat"
	set constFileHdlTvOut    "mean_float.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
