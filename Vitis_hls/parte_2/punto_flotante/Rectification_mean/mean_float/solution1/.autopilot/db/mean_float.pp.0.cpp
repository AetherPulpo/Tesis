...
# 2 "<built-in>" 2
# 1 "mean_float/mean_float.cpp" 2
# 1 "mean_float/mean_float.h" 1

const int DATA_SIZE = 512;



__attribute__((sdx_kernel("mean_float", 0))) void mean_float(float in_data,
    bool in_samples_ready,
    float* out_mean);
# 2 "mean_float/mean_float.cpp" 2
...
__attribute__((sdx_kernel("mean_float", 0))) void mean_float(float in_data,
          bool in_samples_ready,
    float* out_mean){
#pragma HLS TOP name=mean_float
# 8 "mean_float/mean_float.cpp"
