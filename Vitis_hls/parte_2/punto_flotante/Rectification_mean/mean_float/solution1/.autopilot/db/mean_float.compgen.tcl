...
set id 1
set name mean_float_fadd_32ns_32ns_32_5_full_dsp_1
...
set id 2
set name mean_float_fmul_32ns_32ns_32_4_max_dsp_1
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name in_samples_ready \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_in_samples_ready \
    op interface \
    ports { in_samples_ready { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_mean \
    op interface \
    ports { out_mean { O 32 vector } } \
} "
}
